...
const themes = [
    ...
    "写真はスマホで十分 vs 一眼レフカメラが欲しい",
    "LINEの返信はすぐ返す vs 後でまとめて返す",
    "新しいお店はすぐ試す vs 評価を見てから行く",
    "ポイントカードは作る vs 作らない（財布が重くなる）",
    "旅行の計画はきっちり立てる vs 行き当たりばったり",
    "新幹線に乗るなら通路側 vs 窓側",
    "飛行機に乗るなら窓側 vs 通路側",
    "ホテルは素泊まり vs 朝食付き",
    "荷物は最小限 vs 念のため多め",
    ...
    "釣りをやったことがある vs やったことがない",
    "ゴルフに興味がある vs 全く興味がない",
    "ダンスが得意・好き vs 踊るのは恥ずかしい",
    "マジック・手品を見るのは好き vs ネタバレが気になる",
    ...
    "勉強するなら図書館 vs 自分の部屋",
    "暗記ものは夜寝る前 vs 朝起きてすぐ",
    "ノートをとるなら黒・赤の2色 vs カラフルペンを駆使",
    "電卓はブラインドタッチできる vs 見ながら叩く",
    "タイピングはかな入力 vs ローマ字入力",
    "パソコンのOSはWindows vs Mac",
    "スマホはiPhone vs Android",
    "ブラウザはGoogle Chrome vs Safari",
    "検索エンジンはGoogle vs SNS検索",
    "生成AIで記事や文章を作るのはアリ vs ナシ",
    "AIが創ったアート作品は芸術と言える vs 言えない",
    "教科書はすべてタブレット化すべき vs 紙の教科書を残すべき",
    "外国語の学習はAI翻訳で不要になる vs 自力で学ぶべき",
    "プログラミング言語学ぶならPython vs JavaScript",
    "キーボードはメカニカル（カタカタ） vs 静音",
    "モニターはデュアルディスプレイ（2台） vs 超ワイド1台",
    "マウスはトラックボール派 vs 普通のマウス",
    "クラウドストレージ派 vs 外付けHDD・SSD派",
    "バックアップは自動設定 vs 手動でたまにやる",
    "パスワード管理アプリを使う vs 自分で覚える・ノートに書く",
    "セキュリティ対策ソフトは必須 vs OS標準で十分",
    "Web会議でカメラはONにする vs OFFにする",
    "リモートワーク（在宅勤務） vs 出社（オフィス勤務）",
    "残業して稼ぐ vs 定時退社してプライベート重視",
    "会社の飲み会は参加したい vs 参加したくない",
    "成果主義の給与体系 vs 年功序列の給与体系",
    "大企業で安定して働く vs ベンチャー・起業で挑戦する",
    "転職を繰り返してキャリアアップ vs 1つの会社で長く働く",
    "副業・複業は推進すべき vs 本業に集中すべき",
    "プレゼン資料はシンプル（文字少なめ） vs 丁寧（情報量多め）",
    "打ち合わせは対面 vs オンライン",
    "メールの返信は「お世話になっております」を入れる vs 要点だけで即返信",
    "チャットツール（Slack等） vs メール",
    "定例会議は必要 vs チャット報告で十分",
    "文房具のボールペンは0.5mm vs 0.38mm",
    "シャープペンシルの芯はHB vs B",
    "定規は透明プラスチック vs 金属製",
    "クリアファイルで保管 vs バインダーに穴あけ保管",
    "メモを取るなら付箋 vs メモ帳",
    "アイデア出しはマインドマップ vs ポストイット敷き詰め",
    "作業環境は立ちデスク（昇降） vs 座りデスク",
    "キーボード配列は日本語（JIS） vs 英語（US）",
    ...
    "記憶を消してもう一度体験したいゲーム・アニメがある vs ない",
